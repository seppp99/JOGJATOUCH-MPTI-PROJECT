        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div class="lg:col-span-5 relative w-full flex items-center justify-center">
                <div class="relative w-80 h-80 md:w-112 md:h-112 flex items-center justify-center">
                    ...
                    <div class="absolute bottom-6 right-6 w-16 h-16 md:w-25 md:h-25 bg-white/90 backdrop-blur-md rounded-full shadow-lg border border-white/40 z-20 flex items-center justify-center animate-bounce" style="animation-duration: 4.5s;">
                        <div class="w-3 h-3 bg-[#E35D25] rounded-full"></div>
                    </div>
