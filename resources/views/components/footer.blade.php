        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-16 border-b border-white/5 mb-12">
            ...
            <div class="lg:col-span-2 flex flex-col items-start">
                ...
                <div class="flex gap-4">
                    <a href="https://www.instagram.com/jogjatouch?igsh=MXExZ3g3NWxmaTcyaQ==" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full bg-white/5 hover:bg-[#E35D25] hover:text-white text-white/60 flex items-center justify-center transition-colors" aria-label="Instagram">
