<x-layouts.app>
            ...
            <div class="relative bg-white rounded-[2.5rem] p-8 md:p-10 shadow-xl border border-[#1E1B19]/5">
                ...
                <div>
                    ...
                    <form id="login-form" onsubmit="submitLogin(event)">
                        ...
                        <!-- Password Input -->
                        <div class="mb-6">
                            <label for="login-password" class="block text-[11px] font-bold tracking-wider text-[#1E1B19]/50 uppercase mb-2">
                                Password
                            </label>
    ...
    <!-- Handle Login Submission Script -->
    <script>
        function submitLogin(e) {
            ...
            if (!email || !password) {
                errorElement.textContent = 'Email dan Password wajib diisi.';
            ...
            .then(async res => {
                ...
                if (res.ok && data.success) {
                    ...
                    let errorMsg = data.message || 'Email atau password salah.';
                    if (data.errors) {
